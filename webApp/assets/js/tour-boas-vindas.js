...
const PASSOS = [
    { tipo: 'boas-vindas', passoRotulo: 'Bem-vindo(a) ao Futuro+', titulo: 'Quer um tour rápido?', texto: 'Leva uns 30 segundos e mostra onde ficam os testes, o mural e o assistente virtual.' },
    {
        seletor: '.hamburger',
...
export function iniciarTourBoasVindas({ forcar = false } = {}) {
    ...
    iniciarTourSpotlight({ chaveVisto: CHAVE_TOUR_VISTO, passos: PASSOS, forcar });
}
