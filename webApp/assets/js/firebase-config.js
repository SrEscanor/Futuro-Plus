...
import { getFirestore, connectFirestoreEmulator } from "firebase/firestore"; // 1. Importe o Firestore
...
// Aponta para os emuladores quando rodando local (localhost/127.0.0.1)
