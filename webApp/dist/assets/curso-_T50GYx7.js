import{e as C,d as O,b as m,g as w,c as A,f as h}from"./firebase-config-vU8gAbDc.js";import"./dashboard-BxxGHgqt.js";/* empty css                    */import{n as p,e as n}from"./card-unidade-Bgq-fhAV.js";import{r as D,c as L,a as E,P as g}from"./recomendacao-cursos-xAr-dSXz.js";import{f as R}from"./geocodificacao-Da0jM7Fw.js";import"./categorias-teste-82RqXHiT.js";const T="cursos",x="/dados/catalogo-cursos.json";async function S(a){const o=await fetch(x);return o.ok&&(await o.json()).find(e=>e.slug===a)||null}function U(a){return p(a).replace(/\s+/g,"-")}function l(a,o){return o?`
        ...
        </div>`),o.join("")}function M({nivel:a,km:o}){if(o!=null){const s=R(o);return`${s.charAt(0).toUpperCase()}${s.slice(1)} de você`}return a===g.CIDADE?"Na sua cidade":a===g.REGIAO?"Na sua região":""}const $=10;function P(a,o,s){if(!a.length)return'<p class="sem-cursos">Nenhuma unidade do cadastro oferece este curso no momento.</p>';const e=a.map(r=>({unidade:r,proximidade:o?o(r):null}));o&&e.sort((r,c)=>r.proximidade.ordem-c.proximidade.ordem||(r.unidade.nome||"").localeCompare(c.unidade.nome||"","pt-BR"));const t=e.length-$,i=t>0?`<a class="curso-ver-todas" href="cursos.html?curso=${encodeURIComponent(s)}">
