import{e as w,d as I,b as m,g as D,c as L,f as v}from"./firebase-config-XD2rgtmE.js";import"./dashboard-BdJF97nc.js";/* empty css                    */import{n as p,e as n}from"./card-unidade-CA2qFmKO.js";import{r as E,c as R,a as S,P as $}from"./recomendacao-cursos-C9NkKMnp.js";import{f as T}from"./geocodificacao-GFhpmzSl.js";import"./conteudo-legal-padrao-DB74JH29.js";import"./categorias-teste-82RqXHiT.js";const x="cursos",U="/dados/catalogo-cursos.json";async function b(a){const o=await fetch(U);return o.ok&&(await o.json()).find(e=>e.slug===a)||null}function z(a){return p(a).replace(/\s+/g,"-")}function l(a,o){return o?`
